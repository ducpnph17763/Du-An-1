...
public class NguoiDungHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(lblDangXuat, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 530, 200, 40));
        ...
        jPanel1.add(lblTaiKhoan, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 480, 200, 50));
        ...
        jPanel1.add(lblHoaDon, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 430, 200, 50));
        ...
        jPanel1.add(lblDSLD, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 380, 200, 50));
        ...
        jPanel1.add(lblDatLich, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 330, 200, 50));
        ...
        jPanel1.add(lblHoTen, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 240, 110, -1));
        ...
        jPanel1.add(lblHinh, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 120, 120));
        ...
        jDesktopPane1.add(PNchinh, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 0, 1580, 800));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        if (tk == null) {
            ...
            Model.KhachHang kh = khdao.SelectByTenTK(tk.getTenTK());
            this.lblHoTen.setText(kh.getHoTen());
            if (tk.getHinh() == null) {
                this.SetHinh("178831-200.png");
            }
    ...
    private void lblDSLDMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblDSLDMouseClicked
        PNchinh.removeAll();
        DSLichDatNguoiDung main = new DSLichDatNguoiDung();
        PNchinh.add(main);
        main.show();
    ...
    private void lblDatLichMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblDatLichMouseClicked
        PNchinh.removeAll();
        DatLichNguoiDung main = new DatLichNguoiDung();
        PNchinh.add(main);
        main.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NguoiDungHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NguoiDungHome().setVisible(true);
            }
        });
    }
